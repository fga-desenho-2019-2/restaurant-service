...
urlpatterns = [
    ...
    path('restaurant/<str:pk>', RestaurantView.handle_get_by_pk, name="restaurant_by_pk"),
    path('shopping', ShoppingView.handle_get_or_post, name="shopping"),
    path('shopping/<str:pk>', ShoppingView.handle_get_by_pk, name="shopping_by_pk"),
    ...
    path('qrcode/<str:pk>', see_qrcode, name="see_qrcode"),
    ...
    path('restaurant-image/<str:pk_restaurant>', ImageRestaurantView.get_by_fk, name='image_by_restaurant'),
